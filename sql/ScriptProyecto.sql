...
/*  Created On : 29-Jun-2020 3:24:00 PM 				*/
/*  DBMS       : Oracle 						*/
/* ---------------------------------------------------- */
...
(
	  ...
	  NOMBRE_CATEGORIA  VARCHAR2(50) NOT NULL,    -- Nombre de la categoria
	  IVA  NUMBER(3,2) NOT NULL,    -- Iva que se le asigna a las distintas caegorias
...
(
	  ...
	  ESTADO  VARCHAR2(50) NOT NULL,    -- Estado actual del envío (entregado (E) o pendiente (P))
...
(
	  ID_INVENTARIO  NUMBER(8) NOT NULL,    -- Código del inventario
	  EXISTENCIAS  VARCHAR2(50) NOT NULL,    -- Existencias actuales del producto en la tienda
	  ID_PRODUCTO  NUMBER(30) NOT NULL,    -- Codigo del producto almacenado
	  ID_SUCURSAL  NUMBER(8) NOT NULL    -- Codigo de la sucursal a la que pertenece el enventario
)
;
...
(
	  ...
	  ESTADO_PEDIDO  NUMBER(2) NOT NULL,    -- Fase actual del pedido 
	  FECHA_PEDIDO  DATE NOT NULL,    -- Fecha de creacion/modificaciom del pedido
	  TOTAL_PEDIDO  NUMBER(8) NOT NULL,    -- Suma de los costos de todos los productos en el pedido
...
(
	  ...
	  PRECIO_BASE  NUMBER(8,2) NOT NULL,    -- Precio base del producto
	  UNIDAD_MEDIDA  VARCHAR2(50) NOT NULL,    -- Para productos de mercado se manejan lb, kg, g, litros. Para el resto se maneja por Unidad 
...
(
	  ...
	  DIRECCION_PROVEEDOR  NUMBER(20) NOT NULL,    -- Direccion donde se ubica el proveedor
...
(
	  ...
	  NOMBRE_SUBCATEGORIA  VARCHAR2(50) NOT NULL,    -- Nombre de la subcategoria
...
(
	  ...
	  NUMERO  NUMBER(30) NOT NULL,    -- Número de la tarjeta de credito, esta impresa en la tarjeta
	  ...
	  CSC  NUMBER(3) NOT NULL,    -- Card Security Code, codigo de seguridad al respaldo de la tarjeta
...
(
	  ...
	  NUM  NUMBER(15) NOT NULL,    -- Número telefonico del cliente
...
(
	  ...
	  COSTO_ENV_LOC  NUMBER(4,2) NOT NULL,    -- Costo de envio para un pedido en la misma ciudad
	  COSTO_ENV_NAC  NUMBER(4,2) NOT NULL,    -- Costo de envio fuera de la ciudad origen
...
(
	  ...
	  SEGUNDO_NOMB  VARCHAR2(20) NULL,    -- Segundo nombre del usuario
	  ...
	  TIPO_ID  VARCHAR2(50) NOT NULL,    -- Tipo de identificación del cliente
...
COMMENT ON COLUMN    Detalle_Pedido .  ID_DETALLE_PEDIDO  IS 'Codigo del pedido'
;
...
COMMENT ON COLUMN    Inventario .  ID_INVENTARIO  IS 'Código del inventario'
;

COMMENT ON COLUMN    Inventario .  EXISTENCIAS  IS 'Existencias actuales del producto en la tienda'
;

COMMENT ON COLUMN    Inventario .  ID_PRODUCTO  IS 'Codigo del producto almacenado'
;

COMMENT ON COLUMN    Inventario .  ID_SUCURSAL  IS 'Codigo de la sucursal a la que pertenece el enventario'
;
...
COMMENT ON COLUMN    Pedido .  ESTADO_PEDIDO  IS 'Fase actual del pedido '
;
...
COMMENT ON COLUMN    TarjetaCredito .  NUMERO  IS 'Número de la tarjeta de credito, esta impresa en la tarjeta'
;
...
COMMENT ON COLUMN    TarjetaCredito .  CSC  IS 'Card Security Code, codigo de seguridad al respaldo de la tarjeta'
;
...
COMMENT ON COLUMN    Telefono .  NUM  IS 'Número telefonico del cliente'
;
...
ALTER TABLE    Telefono  
 ADD CONSTRAINT   CK_NUM  CHECK (NUM > 0)
;
