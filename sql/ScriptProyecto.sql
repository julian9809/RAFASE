...
/*  Created On : 05-Aug-2020 8:35:23 PM 				*/
/*  DBMS       : Oracle 						*/
/* ---------------------------------------------------- */
...
(
	  ...
	  EN_USO  VARCHAR2(1) NOT NULL,    -- Tarjeta en uso (S) o no en uso (N)
...
COMMENT ON COLUMN    TarjetaCredito .  EN_USO  IS 'Tarjeta en uso (S) o no en uso (N)'
;
