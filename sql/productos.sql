...
INSERT INTO Tienda(ID_TIENDA, COSTO_ENV_LOC, COSTO_ENV_NAC, TIEMPO_VIDA_CARRITO, MIN_CANTIDAD_PRODUCTOS, ID_ADMINISTRADOR) VALUES (1, 5000, 15000, 7, 20,1);

INSERT INTO Ciudad(ID_CIUDAD, NOMBRE, ID_TIENDA) VALUES (1,'Bogota',1);
INSERT INTO Ciudad(ID_CIUDAD, NOMBRE, ID_TIENDA) VALUES (2,'Medellin',1);
INSERT INTO Ciudad(ID_CIUDAD, NOMBRE, ID_TIENDA) VALUES (3,'Cali',1);
INSERT INTO Ciudad(ID_CIUDAD, NOMBRE, ID_TIENDA) VALUES (4,'Cartagena',1);

INSERT INTO Proveedor(ID_PROVEEDOR, NOMBRE_PROVEEDOR, DIRECCION_PROVEEDOR) VALUES (1, 'Proveedor arroz', 'Calle 1 # 1-1');
INSERT INTO Proveedor(ID_PROVEEDOR, NOMBRE_PROVEEDOR, DIRECCION_PROVEEDOR) VALUES (2, 'Proveedor libros', 'Calle 2 # 1-1');
INSERT INTO Proveedor(ID_PROVEEDOR, NOMBRE_PROVEEDOR, DIRECCION_PROVEEDOR) VALUES (3, 'Proveedor musica', 'Calle 3 # 1-1');
INSERT INTO Proveedor(ID_PROVEEDOR, NOMBRE_PROVEEDOR, DIRECCION_PROVEEDOR) VALUES (4, 'Proveedor arroz', 'Calle 4 # 1-1');
INSERT INTO Proveedor(ID_PROVEEDOR, NOMBRE_PROVEEDOR, DIRECCION_PROVEEDOR) VALUES (5, 'Proveedor libros', 'Carrera 1 # 1-1');
INSERT INTO Proveedor(ID_PROVEEDOR, NOMBRE_PROVEEDOR, DIRECCION_PROVEEDOR) VALUES (6, 'Proveedor dulces', 'Carrera 2 # 1-1');
INSERT INTO Proveedor(ID_PROVEEDOR, NOMBRE_PROVEEDOR, DIRECCION_PROVEEDOR) VALUES (7, 'Proveedor tecnologia', 'Carrera 3 # 1-1');
INSERT INTO Proveedor(ID_PROVEEDOR, NOMBRE_PROVEEDOR, DIRECCION_PROVEEDOR) VALUES (8, 'Proveedor arroz', 'Carrera 4 # 1-1');

INSERT INTO Categoria(ID_CATEGORIA, NOMBRE_CATEGORIA, DESCRIPCION_CATEGORIA) VALUES (1, 'Entretenimiento', 'Libros, música y peliculas');
INSERT INTO Categoria(ID_CATEGORIA, NOMBRE_CATEGORIA, DESCRIPCION_CATEGORIA) VALUES (2, 'Hogar', 'Electrodomestidos y muebles');
INSERT INTO Categoria(ID_CATEGORIA, NOMBRE_CATEGORIA, DESCRIPCION_CATEGORIA) VALUES (3, 'Mercado', 'Canasta básica');
...
INSERT INTO Producto VALUES (1, 'El olvido que seremos', 'Alfaguara','7015283947','Biografía novelada','el_olvido_seremos_todos.jpg', 1, 'Unidad', 0);
INSERT INTO Producto VALUES (2, 'El muñeco que cae', 'Arcoiris','70152783947','Cuento','el_muñeco_que_cae.jpg', 1, 'Unidad', 0);
