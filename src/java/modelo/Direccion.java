...
public class Direccion {
    ...
    private ArrayList id_direccion_array = new ArrayList();
    private ArrayList direccion_completa_array = new ArrayList();
    private ArrayList extras_array = new ArrayList();
    private ArrayList tipo_direccion_array = new ArrayList();
    ...
    public ArrayList getId_direccion_array() {
        return id_direccion_array;
    }

    public void setId_direccion_array(ArrayList id_direccion_array) {
        this.id_direccion_array = id_direccion_array;
    }

    public ArrayList getDireccion_completa_array() {
        return direccion_completa_array;
    }

    public void setDireccion_completa_array(ArrayList direccion_completa_array) {
        this.direccion_completa_array = direccion_completa_array;
    }

    public ArrayList getExtras_array() {
        return extras_array;
    }

    public void setExtras_array(ArrayList extras_array) {
        this.extras_array = extras_array;
    }

    public ArrayList getTipo_direccion_array() {
        return tipo_direccion_array;
    }

    public void setTipo_direccion_array(ArrayList tipo_direccion_array) {
